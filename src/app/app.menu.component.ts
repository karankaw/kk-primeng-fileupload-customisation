      ...
      <a [routerLink]="['/']" class="logo">
        <img
          ...
          [src]="
            ...
            (config.dark ? 'primeng-logo-light.svg' : 'primeng-logo-dark.svg')
          "
        />
      </a>
      ...
      <div class="layout-menu">
        ...
        <div class="menu-items">
          ...
          <a href="https://discord.gg/gzKFYnpmCY" target="_blank"
            >Discord Chat</a
          >
          <a [routerLink]="['/lts']" routerLinkActive="router-link-exact-active"
            >Long Term Support</a
          >
          <a
            [routerLink]="['/support']"
        ...
        <div class="menu-items">
          ...
          <a
            [routerLink]="['/colors']"
            routerLinkActive="router-link-exact-active"
            >Colors <span class="p-tag">New</span></a
          >
          <a href="https://www.primefaces.org/designer/api/primeng/11.1.0"
            >SASS API</a
          >
        </div>
        ...
        <div class="menu-items">
          ...
          >
          <a
            [routerLink]="['/primeflex/display']"
            routerLinkActive="router-link-exact-active"
            [routerLinkActiveOptions]="{ exact: true }"
            >Display</a
          >
          <a
            [routerLink]="['/primeflex/elevation']"
            routerLinkActive="router-link-exact-active"
            [routerLinkActiveOptions]="{ exact: true }"
            >Elevation</a
          >
          <a
            [routerLink]="['/primeflex/flexbox']"
            routerLinkActive="router-link-exact-active"
            [routerLinkActiveOptions]="{ exact: true }"
            >FlexBox</a
          >
          <a
            [routerLink]="['/primeflex/formlayout']"
            routerLinkActive="router-link-exact-active"
            [routerLinkActiveOptions]="{ exact: true }"
            >Form Layout</a
          >
          <a
            [routerLink]="['/primeflex/grid']"
            routerLinkActive="router-link-exact-active"
            [routerLinkActiveOptions]="{ exact: true }"
            >Grid System</a
          >
          <a
            [routerLink]="['/primeflex/spacing']"
            routerLinkActive="router-link-exact-active"
            [routerLinkActiveOptions]="{ exact: true }"
            >Spacing</a
          >
          <a
            [routerLink]="['/primeflex/text']"
            routerLinkActive="router-link-exact-active"
            [routerLinkActiveOptions]="{ exact: true }"
            >Text</a
          >
        ...
        <div class="menu-items">
          ...
          <a
            [routerLink]="['/password']"
            routerLinkActive="router-link-exact-active"
            >Password <span class="p-tag">New</span></a
          >
          <a
        ...
        <div class="menu-items">
          ...
          <div>
            ...
            <div
              [@submenu]="isSubmenuActive('/table') ? 'visible' : 'hidden'"
          ...
          <div>
            ...
            <div
              [@submenu]="isSubmenuActive('/tree') ? 'visible' : 'hidden'"
              (@submenu.done)="onAnimationDone()"
            >
              <ul>
                <li>
          ...
          <div>
            <a tabindex="0" (click)="toggleSubmenu($event, '/treetable')"
              >TreeTable</a
            >
            <div
              [@submenu]="isSubmenuActive('/treetable') ? 'visible' : 'hidden'"
              (@submenu.done)="onAnimationDone()"
            >
              <ul>
                <li>
        ...
        <div class="menu-items">
          ...
          >
          <div>
            <a tabindex="0" (click)="toggleSubmenu($event, '/galleria')"
              >Galleria</a
            >
            <div
              [@submenu]="isSubmenuActive('/galleria') ? 'visible' : 'hidden'"
              (@submenu.done)="onAnimationDone()"
            >
              <ul>
                <li>
        ...
        <div class="menu-items">
          ...
          <a
            ...
            >Skeleton</a
          >
          <a [routerLink]="['/tag']" routerLinkActive="router-link-exact-active"
...
export class AppMenuComponent {
  ...
  routes = [
    ...
    },
    {
      label: 'PrimeIcons',
      value: 'primeicons',
      items: [{ label: 'Icons v4.1', value: '/icons' }]
    },
    {
      label: 'Form',
      value: 'form',
    ...
    },
    {
      label: 'Media',
      value: 'media',
      items: [{ label: 'Carousel', value: '/carousel' }]
    },
    {
      label: 'Galleria',
      value: 'galleria',
  ...
  constructor(
    ...
    router.events.subscribe(routerEvent => {
      if (
        ...
        (routerEvent.navigationTrigger === 'popstate' || this.scrollable)
      ) {
